...
return [
    ...
    'employee_search_empty' => 'No matching employees in your access scope. Check the employee code or name.', 'employee_search_error' => 'Employee lookup failed. Please try again.',
    'employee_already_linked' => 'Already linked to a system user. Manage the existing account from Users; do not create a duplicate.',
    'employee_inactive' => 'Employee is not active. Review their HR status before creating an account.',
    'employee_code_used' => 'This employee code is already used by a system user. Ask an administrator to review the existing account link.',
