...
<tr data-row-index="{{ $i }}">
    <td>
        <select name="documents[{{ $i }}][document_type]" class="select js-document-type">
    ...
    <td>
        <input name="documents[{{ $i }}][file]" type="file" class="input js-document-file" accept=".pdf,.jpg,.jpeg,.png,.webp"/>
        {{-- Checking the chosen file before saving it (client feedback FR-03). --}}
